        ...
        <Fragment>
            ...
            <Container className={classes.root}>
                ...
                <Typography variant="body1">
                    ...
                    the time when this application was developed. Both of us are starting school at the University of
                    Waterloo so we won't have as much time to work on this project. Alex will be studying Geomatics and
                    Gary will be studying computer engineering.
                </Typography>
            </Container>
        </Fragment>
    );
